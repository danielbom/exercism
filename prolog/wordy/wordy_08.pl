...
sentence(_) --> beginning, {throw(error(syntax_error, "I cant solve this."))}.
sentence(_) --> {throw(error(unknown_operation_error, "I dont answer those questions."))}.
...
expression(_) --> 
    integer(_), " ", string(_), 
    {throw(error(unknown_operation_error, "I dont know that operation."))}.
